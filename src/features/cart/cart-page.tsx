...
export function CartPage() {
  ...
  if (profile.isPending) return <CartPageSkeleton />;
  ...
  return <section className="page-wrap py-12 sm:py-16">
    ...
    {query.isPending ? <CartPageSkeleton /> : null}
